...
#Creating the window
wn = Tk()
wn.title('ABDULLAAH ALQAASIM QR Code Generator')
wn.geometry('700x700')
...
headingLabel = Label(headingFrame, text="Generate QR Code with Abdullaah AlQaasim", bg='azure', font=('Times',20,'bold'))
...
def generateCode():
  ...
  messagebox.showinfo("ABDULLAAH ALQAASIM  QR Code Generator","QR Code is saved successfully!")
